...
const sampleMessagesDataArray: TMessagesData[] = [
  {
    ...
    messageInParas: [
      "Hey Aunt, it's your birthday! Wishing you the happiest of birthdays filled with all the things you love and cherish the most.",
      ...
      "Happy birthday and cheers to a fantastic year ahead!",
    ],
  ...
  },
  {
    ...
    messageInParas: [
      "Happy Birthday! On this special day, I hope that all of your dreams come true and that you are surrounded by love and happiness. You are a wonderful person who deserves nothing but the best",
      ...
      "May this birthday be just the beginning of a happy journey that will lead you to an even more amazing future. Enjoy your day to the fullest",
      "Once again, happy birthday, Aunt! Cheers to another year of laughter, love, and wonderful memories.",
      "Warm regards,",
      "Yogesh",
    ],
