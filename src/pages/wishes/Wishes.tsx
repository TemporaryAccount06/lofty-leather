...
const sampleMessagesDataArray: TMessagesData[] = [
  {
    ...
    messageInParas: [
      "Hey there Sexy Bear, it's your birthday! Wishing you the happiest of birthdays filled with all the things you love and cherish the most.",
      ...
      "You're a true gem, baby, and I feel lucky to know you. Happy birthday and cheers to a fantastic year ahead!",
    ],
  ...
  },
  {
    ...
    messageInParas: [
      ...
      "Once again, happy birthday, Vanshika baby! Cheers to another year of laughter, love, and wonderful memories.",
      "Warm regards,",
      "Arthur",
    ],
